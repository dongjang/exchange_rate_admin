...
public class AdminManagementController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<AdminResponse> getAdminById(@PathVariable("id") Long id) {
        System.out.println("idttttt: " + id);
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Map<String, String>> updateAdmin(@PathVariable("id") Long id, @RequestBody AdminRequest adminRequest) {
    ...
    public ResponseEntity<Map<String, Object>> checkAdminIdDuplicate(@PathVariable("adminId") String adminId) {
