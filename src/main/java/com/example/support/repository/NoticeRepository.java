...
public interface NoticeRepository extends JpaRepository<Notice, Long> {
     ...
     */
    @Modifying
    @Query(value = "UPDATE notice n SET n.priority = 'NORMAL', n.notice_start_at = NULL, n.notice_end_at = NULL WHERE n.priority = 'HIGH' AND DATE(n.notice_end_at) < DATE(CONVERT_TZ(NOW(), @@session.time_zone, '+09:00'))", nativeQuery = true)
