  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 style={{ fontSize: '1.25rem', fontWeight: 700, marginBottom: '0.5rem', color: '#2563eb' }}>송금 시뮬레이션</h2>
        <p style={{ fontSize: '0.9rem', color: '#64748b', marginBottom: '1.2rem', lineHeight: '1.4' }}>
